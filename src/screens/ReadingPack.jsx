...
function ReadingPackBody({ packId, onBack, onStartReading, onStartDialogue }) {
  ...
  return (
    <div style={{ flex: 1, minHeight: 0, overflowY: "auto", padding: "14px 20px 24px" }}>
      ...
      <p style={{ margin: "32px 0 10px", fontSize: 11, letterSpacing: "0.14em", fontWeight: 800, color: t.ink }}>WHAT YOU'LL READ</p>
      ...
      <p style={{ margin: "72px 0 11px", fontSize: 11, letterSpacing: "0.14em", fontWeight: 800, color: t.ink }}>PRACTICE</p>
...
export default function ReadingPack({ packId, onNav, onBack, onStartReading, onStartDialogue }) {
  return (
    <Shell active="Scenes" onNav={onNav}>
