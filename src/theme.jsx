...
export const LIGHT = {
  ...
  cardShadow: "0 20px 52px -20px rgba(34,52,118,0.20)", // Felix-depth: card floats over the header plane — mild blue tint (not neutral grey), lightened
...
export const DARK = {
  ...
  cardShadow: "0 20px 52px -18px rgba(0,0,0,0.62)", // Felix-depth: card floats over the header plane
