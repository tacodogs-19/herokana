...
export const LIGHT = {
  ...
  cardShadow: "0 20px 52px -20px rgba(34,52,118,0.20), 0 0 10px rgba(34,52,118,0.10)", // Felix-depth bottom lift + a tight even halo so a faint rim shows at the top edge too
...
export const DARK = {
  ...
  cardShadow: "0 20px 52px -18px rgba(0,0,0,0.62), 0 0 10px rgba(0,0,0,0.38)", // Felix-depth bottom lift + a tight even halo so a faint rim shows at the top edge too
