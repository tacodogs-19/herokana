...
export const LIGHT = {
  ...
  doneFill: "#22A968", // brighter success green for SOLID FILLS only (progress chips) — `done` stays dark for AA text/outline contrast
...
export const DARK = {
  ...
  doneFill: "#34C07C", // dark-mode `done` is already bright — fills reuse it
